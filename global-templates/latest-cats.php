...
<?php if ($my_posts->have_posts()) : ?>
	<section class="latest-cats" >
		<div class="container">
				...
				<div style="background-color:<?php echo $bgTextColor; ?>;color:<?php echo $textColor; ?>;" class="col-12 col-md-6 col-lg-6 cats-title-container" data-aos="fade-up">		
				...
				<div class="col-12 col-md-6 col-lg-6 row cat-container">	
					<!-- Loop Latest Cats -->

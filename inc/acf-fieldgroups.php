...
acf_add_local_field_group(array(
	...
	'fields' => array(
		array(
			...
			'name' => '',
			'type' => 'accordion',
			'instructions' => 'Customize the Latest cats shown on the front page.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5ec5a0133dd3b',
			'label' => 'Success Stories Carousel Option',
			'name' => '',
			'type' => 'accordion',
			'instructions' => 'Customize The success stories on the front page.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5ec5a1e887f2e',
			'label' => 'Carousel Background color',
			'name' => 'carousel_bg_color',
			'type' => 'color_picker',
			'instructions' => 'Change the background color for the slider on the front page.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5ec5a37014366',
			'label' => 'Carousel Text color',
			'name' => 'carousel_text_color',
			'type' => 'color_picker',
			'instructions' => 'Change the Text Color above the Slider on the Front Page',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
